...
const supabase_key = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ic2JlcHB6Zmtremhvb2xpb3pzIiwicm9sZSI6ImFub24iLCJpYXQiOjE2Nzc3NTQ4MDQsImV4cCI6MTk5MzMzMDgwNH0.wPtFcN2CGZ9w1wHRvZfRKAK8e8u2ljABkShnwnr-r_k'

const sectionCenter = document.querySelector('.section-center');
const btnContainer = document.querySelector('.btn-container');

// import{ menu } from './data_93.js'
